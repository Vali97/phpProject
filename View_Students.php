...
<title>Universiteti i Tiranës</title>
...
<table width="755">
        ...
        <td>
        	<a href="?tag=student_entry"><input type="button" title="Add new student" name="butAdd" value="Shto " id="button-search" /></a>
        </td>
        <td>
        	<input type="text" name="searchtxt" title="Enter name for search " class="search" autocomplete="off"/>
        </td>
        <td style="float:right">
         	<input type="submit" name="btnsearch" value="Kërko" id="button-search" title="Search Student" />
        </td>
    </tr>
</table>
</form>
