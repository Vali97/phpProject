...
<div id="top_style">
        <div id="top_style_text">
        	Modifikimi i programeve të studimit
...
<div id="top_style">
        <div id="top_style_text">
        	Regjistrimi i programeve të studimit
        </div><!-- end of top_style_text-->
       <div id="top_style_button"> 
       </div><!-- end of top_style_button-->
</div><!-- end of top_style-->
    	...
    	<table border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
                <td colspan="2">
                	...
                	<input type="submit" name="btn_sub" value="Shto" id="button-in"  />
                </td>
            </tr>
            </table>
