...
<table width="800">
	<tr>
        ...
        <td><a href="?tag=faculties_entry"><input type="button" title="Add new Faculties" name="butAdd" value="Shto" id="button-search" /></a></td>
        <td><input type="text" name="searchtxt" title="Enter name for search " class="search" autocomplete="off"/></td>
        <td style="float:right"><input type="submit" name="btnsearch" value="Kërko" id="button-search" title="Search Facuty" /></td>
    </tr>
</table>
</form>
