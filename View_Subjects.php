...
<table width="800">
	<tr>
        ...
        <td><a href="?tag=subject_entry"><input type="button" title="Add new Subjects" name="butAdd" value="Shto" id="button-search" /></a></td>
        <td><input type="text" name="searchtxtz" title="Enter name for search " class="search" autocomplete="off"/></td>
        <td style="float:right"><input type="submit" name="btnsearch" value="Kërko" id="button-search" title="Search Subject" /></td>
    </tr>
</table>
</form>
...
<div id="content-input">
    ...
    ?>
      <tr bgcolor="<?php echo $color?>">
            ...
            <td align="center"><a href="?tag=subject_entry&opr=upd&rs_id=<?php echo $row['sub_id'];?>" title="Modifiko"><img src="picture/update.png" /></a></td>
            <td align="center"><a href="?tag=view_subjects&opr=del&rs_id=<?php echo $row['sub_id'];?>" title="Fshij"><img src="picture/delete.png" /></a></td>
        </tr>
    <?php	
    }
    ?>
